...
💡 I enjoy solving real-world problems with machine learning  
⚽ My curiosity for AI started while collecting live data as a soccer statistician  
🔧 Currently building my own Raspberry Pi voice assistant  
...
| 🗂️ **Mini-Notion App** | FastAPI, SQLite | CRUD app with authentication & data persistence |
